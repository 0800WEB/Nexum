...
const BlogCard = () => {
    return (
        <Link to={"/blog/de-esta-manera-logramos-publicidad-efectiva-en-nuestros-clientes"} className="w-[483.78px] h-[490px] flex-col justify-start items-start gap-4 inline-flex text-left">
