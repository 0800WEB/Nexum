...
const CaseCard = () => {
  return (
    <Link to={"/casos-de-exito/exar"} className='min-w-[333.333px] max-w-[483px] max-h-[390px] bg-white relative flex-shrink cursor-pointer flex-1'>
        <img className='' src="/assets/cases/exar.webp" alt="Exar" />
